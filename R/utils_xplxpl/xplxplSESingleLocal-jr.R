...
#' infill optimization of each iteration) 
...
#' 
xplxplSESingleLocal = function(n.iter, res.mbo, n.init, opt.path, pars, n.prop.points) {
  ...
  for (i in 1:(n.iter)) { 
    ...
    sm.seen = predict(object = sm, newdata = seen.points) 
