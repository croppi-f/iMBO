#' Modification of proposePoints: insert ""cbXplxpl" = proposePointsConstantLiarXplxpl(opt.state), " in line 31
#' 
  ...
  if (control$n.objectives == 1L) {
    if (is.null(control$multipoint.method)) {
      ...
      res = switch(control$multipoint.method,
                   ...
                   "clXplxpl" = proposePointsConstantLiarXplxpl(opt.state), 
